...
def myfxbook_members_scrap(current_dir, href, stop_date, dict_for_traders):
    site = 'myfxbook'
    ...
    for i in range(30):
        try:
            driver.execute_script("arguments[0].scrollIntoView();",
                                  driver.find_element("xpath", fr'//a[@name = "history"]'))
            driver.find_element("xpath", fr'//a[@name = "history"]').click()
            break
        except:
            try:
